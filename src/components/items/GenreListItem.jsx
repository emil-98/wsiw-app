...
const GenreListItem = ({name, isSelected, handleClick}) => {

  return (
    <a 
      onClick={() => handleClick()}
      className={`flex h-fit w-fit m-1 rounded-full bg-gradient-to-tr from-purple-500 to-blue-500 cursor-pointer group transition-colors duration-200`}
    >
