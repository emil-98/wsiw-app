...
const MovieListItem = ({posterPath, title, year, rating, numVotes, summary}) => {
  ...
  return (
    <div 
      className='flex group w-fit h-fit z-0'>
      ...
      <div style={{'--img-url': `url(${posterURL})`}}
        ...
        <div className='flex flex-col justify-end h-full w-full p-4 bg-gray-950 bg-opacity-0 group-hover:bg-opacity-90 transition-all duration-200'>
          
          <h3 className='flex w-fit h-fit text-xl text-opacity-0 font-bold group-hover:text-opacity-100 transition-all duration-200'>
            {title}
          </h3>
          <p className='flex w-fit h-fit p-[4px] rounded-sm bg-opacity-0 group-hover:bg-opacity-25 bg-gray-400 text-gray-300 text-xs text-opacity-0 group-hover:text-opacity-100 transition-all duration-200'>
            {year}
          </p>
          <p className='flex w-full p-[4px] rounded-sm bg-opacity-0 group-hover:bg-opacity-25 text-gray-300 text-xs text-opacity-0 group-hover:text-opacity-100 transition-all duration-200'>
            {summary}
          </p>
          <RatingScale
            score={rating}
